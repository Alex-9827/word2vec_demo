...
cut_txt('./data/天龙八部.txt')  # 须注意文件必须先另存为utf-8编码格式

save_model_name = '天龙八部.model'
...
# 计算两个词的相似度/相关程度
y1 = model_1.similarity("萧峰", "段誉")
# print(u"赵敏和韦一笑的相似度为：", y1)
print(u"萧峰和段誉的相似度为：", y1)

print("-------------------------------\n")

# 计算某个词的相关词列表
y2 = model_1.most_similar("逍遥派", topn=10)  # 10个最相关的
# print(u"和张三丰最相关的词有：\n")
# print(u"和九阳真经最相关的词有：\n")
# print(u"和北冥神功最相关的词有：\n")
print(u"和逍遥派最相关的词有：\n")
